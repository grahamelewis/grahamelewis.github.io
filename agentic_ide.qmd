...
Since then I have moved to a newer version that I now use day to day: a standalone app that is significantly more stable, translates the agent's raw commands into readable activity, renders LaTeX math directly in conversations and artifacts, and handles teams of agents working in parallel more cleanly. It is not public yet, but if you would like to try it, email me at lewi1837 @ umn.edu and I would be glad to share a copy.
